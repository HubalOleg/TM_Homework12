package oleg.hubal.com.tm_homework12.list;
...
import oleg.hubal.com.tm_homework12.User;
...
public class UserListFragment extends Fragment {
    ...
    private void readUsers() {
        Cursor c = database.query(Constants.DB_TABLE, null, null, null, null, null, null);
        if(c.moveToFirst()) {
